...
/// The issues with these test has to do with the addition of 'AND start_time >= DATE_ADD(now(), INTERVAL 15 MINUTE)' lines in
//  The Pdo class.  now() in the database is not synced with now() in php.  Figure out how to sync these!  Solving this issue shold
//  kill 2 birds with 1 stone.  We'll need these to be synced and be in UTC before shipping.
